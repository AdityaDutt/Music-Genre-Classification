...
# -------------------------- Feature extraction ----------------------------------------------------
file = open('validation_features.csv', 'w', newline='')
        ...
        try:
            ...
            if time > min_duration :
                ...
                while iter !=0 :
                    ...
                    file = open('validation_features.csv', 'a', newline='')
                    with file:
                        writer = csv.writer(file)
        ...
        try:
            ...
            if time > min_duration :
                ...
                while iter !=0 :
                    ...
                    # plt.savefig("outputnonprog.png",bbox_inches='tight',transparent=True,pad_inches=0)
                    # im = cv2.imread("outputnonprog.png")
                    # plt.clf()
                    # plt.cla()
                    # plt.close()
                    chroma_stft = librosa.feature.chroma_stft(y=chunk, sr=sr)
                    ...
                    # np.savez_compressed("/Users/richadutt/Documents/ranga/mfcc_validation_set/nonprog-"+name+"chunk"+str(chunk_index),im,im)
                    chunk_index += 1
                ...
                # np.savez_compressed("/Users/richadutt/Documents/ranga/mfcc_validation_set/nonprog-"+name+"chunk1",im,im)
